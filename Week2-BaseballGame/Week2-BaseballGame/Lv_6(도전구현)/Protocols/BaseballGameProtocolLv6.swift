// Command Line Tool Project file for BaseballGame Lv_6 - Protocols/BaseballGameProtocol
// 작성일: 2024.11.07 (목요일)
//
// 작성자: Jamong
// 이 파일은 Lv_6의 기본 기능을 정의하는 BaseballGameProtocolLv6을 포함한다.


/// 야구 게임의 기본 기능을 정의하는 프로토콜
/// 게임 시작과 입력 검증 기능일 제공
protocol BaseballGameProtocolLv6 {
