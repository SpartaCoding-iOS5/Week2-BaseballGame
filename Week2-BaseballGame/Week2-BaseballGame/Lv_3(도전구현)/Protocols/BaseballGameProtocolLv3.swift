// Command Line Tool Project file for BaseballGame Lv_3 - Protocols/BaseballGameProtocol
// 작성일: 2024.11.06 (수요일)
//
// 작성자: Jamong
// 이 파일은 Lv_3의 기본 기능을 정의하는 BaseballGameProtocolLv3을 포함한다.


/// 야구 게임의 기본 기능을 정의하는 프로토콜
/// 게임 시작과 입력 검증 기능일 제공
protocol BaseballGameProtocolLv3 {
    /// 정답을 저장하는 배열
