// Command Line Tool Project file for BaseballGame Lv_3 - Models/AnswerCreator
// 작성일: 2024.11.06 (수요일)
//
// 작성자: Jamong
// 이 파일은 Lv_3의 정답을 생성하는 AnswerCreatorLv3 클래스를 정의한다.
// AnswerCreatorLv3는 0에서 9까지의 서로 다른 세 자리 숫자를 생성한다.

import Foundation

///  야구 게임에 필요한 세 자리 정답을 생성하는 클래스
///  정답은 0부터 9까지의 중복되지 않은 세 개의 숫자로 구성
class AnswerCreatorLv3 {
