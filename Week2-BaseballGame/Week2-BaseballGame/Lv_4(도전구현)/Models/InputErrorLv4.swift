// Command Line Tool Project file for BaseballGame Lv_4 - Models/InputError
// 작성일: 2024.11.07 (목요일)
//
// 작성자: Jamong
// 이 파일은 Lv_4의 입력 검증 과정에서 발생할 수 있는 오류를 정의하는 InputErrorLv4 열거형을 포함한다.

import Foundation

/// 입력 오류를 처리하기 위한 열거형
/// 잘못된 길이, 숫자가 아닌 문장, 중복된 숫자에 대한 오류를 정의한다.
/// Lv4의 열거형에서 오류 메세지 추가
enum InputErrorLv4: Error {
